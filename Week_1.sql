...
VALUES
  ...
  #1What is the total amount each customer spent at the restaurant?
...
order_date asc) as rnk
  ...
  #4What is the most purchased item on the menu and 
...
/*case when 
s.customer_id=me.customer_id and order_date<join_date then 'null'
when s.customer_id !=me.customer_id then 'null'
else 
end as 'ranking'*/
